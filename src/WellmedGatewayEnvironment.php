...
abstract class WellmedGatewayEnvironment extends BaseServiceProvider{
    protected $__config_wellmed_gateway = [];
    ...
    public function __construct(Container $app) {
        ...
        $this->__config_wellmed_gateway = $this->__config['wellmed-gateway'];
    }
